...
from FinalPractice.ObjectDetection.YOLO.keras_darknet19 import (DarknetConv2D, DarknetConv2D_BN_Leaky, darknet_body)
...
def yolo_eval(yolo_outputs,
    ...
    iou_threshold = K.variable(iou_threshold, dtype='float32')
